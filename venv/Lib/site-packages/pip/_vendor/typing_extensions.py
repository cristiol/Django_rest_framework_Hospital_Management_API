...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        ...
        __call__ = dict  # staticfiles method
...
everything the runtime allows may be accepted by staticfiles type checkers.
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        classes. It is useful primarily for staticfiles checks.
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        by staticfiles type checkers. At runtime, NewType(name, tp) returns
